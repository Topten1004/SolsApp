...
import { CloudPurchaseFiles } from '../../../../redux/actions/cloud';
...
const FolderList = (props) => {
    ...
    React.useEffect(() => {
        CloudPurchaseFiles(web3Provider) ;
    }, []) ;
...
FolderList.propTypes = {
    CloudPurchaseFiles : PropTypes.func.isRequired
}
const mapStateToProps = state => ({
    ...
    videoTotalSize : state.cloud.purchase.videoTotalSize,
    imageTotalSize : state.cloud.purchase.imageTotalSize,
    audioTotalSize : state.cloud.purchase.audioTotalSize,
    documentTotalSize : state.cloud.purchase.documentTotalSize,
