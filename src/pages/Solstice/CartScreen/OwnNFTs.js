...
import NFTsList from '../../../components/Solstice/CartScreen/NFTs/NFTsList';
...
const OwnNFTs = (props) => {
    ...
    return (
        <Box className={classes.root}>
            <Grid container>
                <Grid item xs={12} sx={{display : 'flex', alignItems : 'center', justifyContent : 'flex-end',  mt : '30px'}}>
...
export default connect(mapStateToProps, mapDispatchToProps)(OwnNFTs) ;