                ...
                <Grid item xs={12} sx={{zIndex : 1000}} >
                    <Grid container>
                        <Grid item xs={6} className={classes.leftBottomDiv}>
                            <Box className={classes.tickDiv} sx={{paddingLeft : '40px'}}>
                                Do you run a creator business? 
                            </Box>
                            <Box className={classes.tickDiv} sx={{paddingLeft : '80px'}}>
                                Gain unstoppable insgihts with affordable/ 
                            </Box>
                            <Box className={classes.tickDiv} sx={{paddingLeft : '100px'}}>
                                USet up a 15 minute call with our team using the link below.  
                            </Box>
                            <Box className={classes.tickDiv} sx={{paddingLeft : '60px'}}>
                                Unlock
                            </Box>
                        </Grid>
